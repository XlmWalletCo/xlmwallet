...
class Federation_model extends CI_Model {
        ...
        */
        ...
        private function linkNameToAccountId($data) {
            ...
            $this->db->select('*');
            $this->db->from('user');
            $this->db->where('stellar_address', $name.'*xlmwallet.co');
            $query2 = $this->db->get();
            ...
            $this->db->insert('user',            
                array(
                   'stellar_address' => strtolower($name).'*xlmwallet.co',
        ...
        */
        private function linkEmailToAccountId($data) {
            ...
            $this->db->select('*');
            $this->db->from('user');
            $this->db->where('stellar_address', $email.'*xlmwallet.co');
            $query = $this->db->get();
            ...
            $this->db->insert('user',            
                array(
                   'stellar_address' => strtolower($email).'*xlmwallet.co',
                   'account_id' =>  $accountId
                )
            ); 
