...
<div class="row bluegrey padding-UB-large blue-grey-text text-lighten-3 hide" style="margin-bottom:0px !important;">
	<div class="container">
		...
		<span class="red-text text-lighten-2">XLMwallet do not store nor have access to these data, if you lose your secret key, your funds will be lost too.</span></p>
...
<section class="padding-UB-large" id="loader">
	<div class="row center-align margin-UB padding-UB-large">
		...
		<h4 class="purple-text darken-1 margin-U">loading</h4>
		<h5 class="white-text darken-1 light margin-UB">please wait...</h5>
  	</div>
</section>

<div class="row hide bluegrey left-align padding-UB" style="margin-bottom:0;">
	<div class="container">
		<h5 class="purple-text">funds received</h5>
	</div>
</div>

<div class="row hide bluegrey center-align padding-UB-large" style="margin-bottom:0;">
	...
	<div class="container padding-UB">
		...
		<div>
			<div class="funds">		
				<div><i class="fa fa-money purple-text fa-4x"></i></div>
				<h5 class="grey soft-bluegrey white-text text-darken-2 padding-UB"><span></span> XLM</h5>
			</div>
...
<div class="row hide bluegrey left-align padding-UB" style="margin-bottom:0;">
	<div class="container">
		<h5 class="purple-text">funds destination</h5>
	</div>
</div>
<div class="row hide bluegrey center-align padding-UB-large" style="margin-bottom:0;">
	...
	<div class="container padding-UB">
		...
		<div>
			<a class="btn btn-large purple waves-effect waves-light z-depth-3 pulse newaccount">NEW ACCOUNT</a><br/>
			<a class="btn btn-large purple white-text lighten-1 waves-effect waves-light margin-U existingaccount">EXISTING ACCOUNT</a>
...
<div class="row hide bluegrey left-align padding-UB" style="margin-bottom:0;">
	<div class="container">
		<h5 class="purple-text">learn more</h5>
	</div>
</div>
<div class="row hide bluegrey blue-grey-text text-lighten-2 left-align padding-UB-large">
	...
	<div class="container padding-UB">
		Lost? You can learn more about xlmwallet &amp; stellar by <a href="/getstarted" target="_blank">clicking here</a>.
	</div>
...
<div id="newAccountModal" class="modal bluegrey grey-text">
	<div class="modal-content">
	  <h4 class="flow-text purple-text">New account</h4>
	  <div class="row">
		...
		<div class="input-field margin-U-large">
			<i class="fa fa-lock prefix purple-text"></i>
			<input type="text" readonly id="secretkey">
			<label for="secretkey">Secret key</label>
		</div>

		 <div class="divider bluegrey margin-U-large"></div>
	  ...
	  <div class="row center-align buttons">
	  	<a class="btn btn-large gradient waves-effect waves-green z-depth-3 claim">CLAIM</a>
	  </div>
...
<div id="existingAccountModal" class="modal bluegrey grey-text">
	<div class="modal-content">
	  <h4 class="flow-text purple-text">Existing account</h4>
	  <div class="row">
		<p>Enter the public address or federated address of the existing account:</p>
		<div class="input-field margin-U-large">
			<i class="fa fa-rocket prefix purple-text"></i>
	  ...
	  <div class="row center-align buttons">
	  	<a class="btn btn-large gradient waves-effect waves-green z-depth-3 toexisting">SEND FUNDS</a>
	  </div>
...
<div id="loadingModal" class="modal bluegrey grey-text">
	<div class="modal-content">
	  <h4 class="flow-text purple-text">Please wait</h4>
