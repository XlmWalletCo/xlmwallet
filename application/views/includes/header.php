...
<html>
<head>
	<title>XLMwallet - XLM Web Wallet</title>
...
<body class="<?php if(isset($bgColor)) { echo $bgColor; } else { echo 'black'; } ?>">
  <nav>
    <div class="nav-wrapper punk">
    	<div class="container">
	      <a href="home"  id="logo" class="purple-text-logo brand-logo light">XLMwallet</a>
	      <ul id="nav-mobile" class="right hide-on-med-and-down">
	        <li><a href="getstarted">Get started</a></li>
	        <li><a id="mywallet" class="btn waves-effect waves-light btn-logout purple-border" href="my">My wallet</a></li>
	      </ul>
	     </div>
