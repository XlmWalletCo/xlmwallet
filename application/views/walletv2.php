...
<section class="padding-UB-large" id="loader">
	<div class="row center-align margin-UB padding-UB-large">
		...
		<h4 class="purple-text darken-1 margin-U">{{text.loading}}</h4>
		<h5 class="white-text darken-1 light margin-UB">{{text.wait}}</h5>
  	</div>
</section>
...
<!-- WALLET UNLOCK -->
<section class="padding-UB-large bg-wallet lighten-3" id="unlock">
	<div class="row center-align margin-UB padding-UB-large">
		<h4 class="purple-text darken-1">{{text.alreadyHaveWallet}}</h4>
		<h5 class="white-text darken-1 light margin-UB">{{text.enterSecretToUnlock}}</h5>
  	</div>
	  ...
	  <div class="row" id="unlockForm">
	    <form class="col s12">
	      ...
	      <div class="row center-align">
			<a id="unlockBtn" href="#" class="btn waves-effect btn-large waves-light gradient white-text z-depth-2">{{text.unlock}}</a>
	      </div>
	    </form>
	  </div>
...
<!-- WALLET GENERATE -->
<section class="padding-UB-large soft-purplemin darken-4" id="generate">
	<div class="row center-align margin-UB padding-UB-large">
		<h4 class="purple-text darken-1">{{text.noWalletYet}}</h4>
		<h5 class="white-text darken-1 light margin-UB">{{text.getWalletNow}}</h5>
  	</div>

  	<div class="container">
		<div class="row center-align padding-UB-large">
			<a href="getstarted" class="btn waves-effect btn-large gradient white-text z-depth-3 margin-UBLR">{{text.getStarted}}</a>
			<a id="generateKeypair" class="btn waves-effect btn-large waves-light purple-border white-text  z-depth-3 margin-UBLR">{{text.generateKeypair}}</a>
		</div>
	</div>
</section>
...
<!-- WALLET SLIDE SEND -->
<section class="transaction white-text padding-UB-large valign-wrapper top-border" id="walletSend">
  	<div class="container">
  		<div class="row">
  			<div class="close right">
				<a href="#" class="fa-stack fa-lg">
				  <i class="fa fa-circle white-text text-darken-4 fa-stack-2x"></i>
		    ...
		    <form class="col l5 m8 s12  soft-bluegrey padding-UBLR-large border-radius" id="walletSendForm">
  			<h5 class="purple-text-logo">{{text.sendMoney}}</h5>
		      ...
		      <div class="row center-align">
		      	<a id="sendLumens" class="btn btn-large gradient white-text waves-effect waves-green z-depth-2"><i class="fa fa-send"></i> <b>{{text.send}}</b></a>
		      </div>
		     </form>
...
<section class="transaction white-text padding-UB-large valign-wrapper top-border" id="walletReceive">
  	<div class="container">
  		<div class="row">
  			<div class="close right">
				<a href="#" class="fa-stack fa-lg">
		    ...
		    <form class="col l6 m8 s12 soft-bluegrey padding-UBLR-large border-radius">
	  		  <h5 class="purple-text-logo">{{text.receiveLumens}}</h5>
			  <div class="row margin-U">

			        <div class="input-field col s12">
			          <i class="fa fa-rocket prefix gradient-text"></i>
			          <input id="publicAddress" readonly value="loading..." type="text">
			          <label for="publicAddress">{{text.receivePublicAddress}}</label>
			        </div>
		    
		        	<p class="center-align white-text text-darken-2">{{text.or}}</p>

			        <div class="input-field col s12 margin-U-large">
			          <i class="fa fa-user prefix gradient-text"></i>
  		...
  		<div class="row">
		    ...
		    <form class="col l6 m8 s12 soft-bluegrey padding-UBLR-large border-radius">
	  		  <h5 class="purple-text-logo">{{text.explanations}}</h5>
		      <div class="row margin-U">
		        	<p class="grey-text text-lighten-1 small"><b class="purple-text text-lighten-3">{{text.publicAddressTitle}}:</b> {{text.publicAddressDesc}}</p>
		        	<p class="grey-text text-lighten-1 small"><b  class="purple-text text-lighten-3">{{text.federatedNameTitle}}:</b> {{text.federatedNameDesc}}</p>
		      </div>

		      <div class="divider bluegrey"></div>

  			<h5 class="purple-text-logo">{{text.tools}}</h5>
		    <div class="row margin-U">

	  			<a class="btn btn-large wallet-header gradient-text waves-effect waves-light tooltipped editFederatedName" data-position="top" data-delay="100" data-tooltip="Federated name">
					<div class="fa-stack">
						  <i class="fa fa-user fa-stack-2x gradient-text"></i>
						  <i style="top:-10px; left:5px; font-size:12px;" class="fa fa-tag gradient-text text-darken-3 fa-stack-1x"></i>
					</div>
				</a>
...
<section class="transaction white-text padding-UB-large valign-wrapper top-border" id="walletInspect">
<div class="container">
      ...
      <div class="row">
	    ...
	    <form class="col l6 m8 s12  soft-bluegrey padding-UBLR-large border-radius" id="walletInspectForm">
  			<h5 class="purple-text-logo">{{text.inspect}}</h5>
	        ...
	        <div class="col s12 center-align">
	        	<a class="btn btn-large gradient waves-effect waves-light z-depth-2 margin-U" id="walletInspectBtn">{{text.inspect}}</a>
	        </div>
        </form>
...
<!-- WALLET SLIDE CHARTS -->
<section class="transaction white-text padding-UB-large valign-wrapper top-border" id="walletCharts">
  	<div class="container soft-bluegrey padding-UBLR-large border-radius">
  		<div class="row">
  			...
  			<h5 class="purple-text-logo">{{text.charts}}</h5>
		      <div class="row">
...
<section class="transaction white-text padding-UB-large valign-wrapper top-border" id="walletHoldings">
<div class="container">
      ...
      <div class="row ">
		...
		<div class="col s12 l7 soft-bluegrey padding-UBLR-large border-radius">
  			<h5 class="purple-text-logo margin-B">{{text.holdings}}</h5>
			 <nav class="nav-extended bluegrey margin-U">
			    <div class="nav-content">
			      <ul class="tabs tabs-transparent">
			        <li class="tab"><a class="active" href="#hassets">{{text.assets}}</a></li>
			        <li class="tab"><a href="#hanchor"><i class="fa fa-plus gradient-text"></i> {{text.anchor}}</a></li>
			...
			<div id="htrust">
		        ...
		        <div class="input-field col s12">
		          <i class="fa fa-tag prefix gradient-text"></i>
		        ...
		        <div class="input-field col s12">
		          <i class="fa fa-calculator prefix gradient-text"></i>
		        ...
		        <div class="col s12 center-align">
		        	<a id="hUpdateTrust" class="btn btn-large gradient waves-effect waves-light white-text">{{text.update}}</a>
		        </div>
			...
			<div id="hanchor">
		        ...
		        <div class="col s12 center-align">
		        	<a id="hSearchAnchor" class="btn gradient waves-effect waves-light white-text">{{text.search}}</a>
		        </div>
...
<section class="transaction white-text padding-UB-large valign-wrapper top-border" id="walletCommunity">
  	<div class="container ">
  		<div class="row">
  			<div class="close right">
				<a href="#" class="fa-stack fa-lg">
  			...
  			<div class="col s12 m8 l6 soft-bluegrey padding-UBLR-large border-radius">
	  			<h5 class="purple-text-logo">{{text.community}}</h5>
				  <div class="col s12">
				    <h5><i class="fa fa-comments gradient-text"></i> {{text.boards}}</h5>
				    <ol>
				  ...
				  <div class="col s12">
				    <h5><i class="fa fa-certificate gradient-text"></i> {{text.official}}</h5>
				    <ol>
				  ...
				  <div class="col s12">
				    <h5><i class="fa fa-credit-card-alt gradient-text"></i> {{text.buy_sell_exchanges}}</h5>
				    <ol>
  		...
  		<div class="row">
		    ...
		    <form class="col l6 m8 s12 soft-bluegrey padding-UBLR-large border-radius">
		      ...
		      <div class="row">
		        ...
		        <div class="col s12">
		        	<p class="grey-text">You can support XLMwallet by donating some Lumens to this address, thank you :)</p>
		        </div>
...
<section class="transaction white-text padding-UB-large valign-wrapper top-border" id="walletSettings">
  	<div class="container soft-bluegrey padding-UBLR-large border-radius">
  		...
  		<div class="row">
	      	...
	      	<h5 class="purple-text-logo">{{text.settings}}</h5>
  		</div>
		  ...
		  <div id="sgeneral">
		  	<div class="row padding-LR margin-UB-large">
			    ...
			    <div class="padding-LR">
				    <div class="col s12 margin-U">
				      ...
				      <label class="white-text" for="settingsShowTooltips">{{text.settingsShowTooltips}}</label>
				    </div>
			...
			<div class="divider margin-UB-large bluegrey"></div>
		  	<div class="row padding-LR">
			    <h5>{{text.accounts}}</h5>
			    <div class="padding-LR">
				  <form class="margin-U" id="walletsList purple-text" action="#">

				  </form>
				 
				  <p><a id="settingsAccountsConfig" class="btn gradient darken-3 waves-effect waves-light"><i class="fa fa-cog"></i></a></p>
				</div>
			</div>

			<div class="divider margin-UB-large bluegrey"></div>

			<p id="xwVersion" class="white-text text-darken-3">{{text.version}} -</p>
		  	...
		  	<div class="row margin-UB-large padding-LR">
			    ...
			    <div class="col s12 margin-U padding-LR">
			        <div class="input-field">
			        	  <i class="fa fa-usd center-align prefix gradient-text"></i>
			...
			<div class="divider margin-UB-large bluegrey"></div>
		  	...
		  	<div class="row margin-UB-large padding-LR">
			    ...
			    <div class="col s12 margin-U">
			        ...
			        <div class="col s12 ">
			        	<a id="settingsSetInflationDestination" class="btn gradient white-text waves-effect waves-light">{{text.set}}</a>
			        </div>
		        </div>
...
<!-- WALLET HEADER -->
<section class="wallet-header padding-UB-large margin-B" id="walletHeader">
  	<div class="container">
		<div class="row grey-text valign-wrapper">
			<div class="col s12 l8 left">
				<h5 class="purple-text-logo"><b id="activeWalletName"></b>{{text.english_s}} {{text.wallet}} <a href="#" class="toolHoldings silver-text"><small><i class="fa fa-list"></i></small></a> </h5>
				<h4 class="white-text text-darken-3 light" id="lumensBalance">0<small>.0000000</small> XLM</h4>
				<h5 class="light silver-text" id="usdBalance"><small>$0.00</small></h5>
			</div>

			<div class="col s12 l4 right right-align">
				<a href="#" id="toolSendLumens" class="btn btn-large dark gradient-text waves-effect waves-light tooltipped margin-UB" data-position="top" data-delay="100" data-tooltip="{{text.sendMoney}}">					
					<div class="fa-stack">
					  <i style="top:5px;" class="fa fa-send fa-stack-2x gradient-text"></i>
					  <i style="top:-10px;" class="fa fa-usd gradient-text fa-stack-1x"></i>
					</div>
				</a>
				<a href="#" id="toolReceiveLumens" class="btn btn-large dark gradient-text waves-effect waves-light tooltipped margin-UB" data-position="bottom" data-delay="100" data-tooltip="{{text.receiveMoney}}">	
					<div class="fa-stack">
					  <i  style="top:5px;"  class="fa fa-credit-card fa-stack-2x gradient-text"></i>
					  <i style="top:-10px;" class="fa fa-arrow-down gradient-text text-darken   fa-stack-1x"></i>
					</div>
				</a>
			</div>
		...
		<p id="minimumBalance" class="hide bluegrey lighten-2 silver-text text-darken-2 padding-UB center-align">{{text.nonExistingAccountNotice}}</p>
...
<section class="white-text" id="walletTools">
  	<div class="container">
  		<div class="row padding-UB hide-on-med-and-down">
			<h5>{{text.tools}}</h5>
			<a href="#" class="toolInspect btn btn-large wallet-header gradient-text waves-effect waves-light margin-UB tooltipped" data-position="bottom" data-delay="100" data-tooltip="{{text.inspect}}"><i class="fa fa-search gradient-text"></i></a>
			<a href="#" class="toolCharts btn btn-large wallet-header gradient-text waves-effect waves-light margin-UB tooltipped" data-position="bottom" data-delay="100" data-tooltip="{{text.charts}}"><i class="fa fa-line-chart gradient-text"></i></a>
			<a href="#" class="toolHoldings btn btn-large wallet-header gradient-text waves-effect waves-light margin-UB tooltipped" data-position="bottom" data-delay="100" data-tooltip="{{text.holdings}}"><i class="fa fa-briefcase gradient-text"></i></a>
			<a href="#" class="toolCommunity btn btn-large wallet-header gradient-text waves-effect waves-light margin-UB tooltipped" data-position="bottom" data-delay="100" data-tooltip="{{text.community}}"><i class="fa fa-users gradient-text"></i></a>
			<a href="#" class="toolSettings btn btn-large wallet-header gradient-text waves-effect waves-light margin-UB tooltipped" data-position="bottom" data-delay="100" data-tooltip="{{text.settings}}"><i class="material-icons gradient-text">settings</i></a>
		...
		<div class="tools hide-on-large-only">
			<a href="#" class="toolInspect btn btn-large wallet-header gradient-text waves-effect waves-light margin-UB tooltipped" data-position="top" data-delay="100" data-tooltip="{{text.inspect}}"><i class="fa fa-search gradient-text"></i></a>
			<a href="#" class="toolCharts btn btn-large wallet-header gradient-text waves-effect waves-light margin-UB tooltipped" data-position="top" data-delay="100" data-tooltip="{{text.charts}}"><i class="fa fa-line-chart gradient-text"></i></a>
			<a href="#" class="toolHoldings btn btn-large wallet-header gradient-text waves-effect waves-light margin-UB tooltipped" data-position="top" data-delay="100" data-tooltip="{{text.holdings}}"><i class="fa fa-briefcase gradient-text"></i></a>
			<a href="#" class="toolCommunity btn btn-large wallet-header gradient-text waves-effect waves-light margin-UB tooltipped" data-position="top" data-delay="100" data-tooltip="{{text.community}}"><i class="fa fa-rocket gradient-text"></i></a>
			<a href="#" class="toolSettings btn btn-large wallet-header gradient-text waves-effect waves-light margin-UB tooltipped" data-position="top" data-delay="100" data-tooltip="{{text.settings}}"><i class="material-icons gradient-text">settings</i></a>
...
<div class="modal-content">
  <h4 class="flow-text purple-text">{{text.confirmLogoutTitle}}</h4>
  <p>
...
<div class="modal-content">
  <h4 class="flow-text purple-text-logo">{{text.waitAlt}}</h4>
  <div class="row center-align">
...
<div id="federatedNameModal" class="modal bluegrey grey-text">
	<div class="modal-content">
	  <h4 class="flow-text purple-text-logo">{{text.federatedNameTitle}}</h4>
	  <div class="row">
	  	...
	  	<div class="input-field col s12 m4 l4">
	  		<input type="text" value="*xlmwallet.co" readonly/>
	  	</div>
	  </div>
	  <p class="red-text text-lighten-1">{{text.federatedNameWarning}}</p>
	</div>
	<div class="modal-footer soft-bluegrey white-text">
	  <a class="modal-action modal-close waves-effect waves-green btn-flat white-text set">{{text.set}}</a>
...
<div id="mergeAccountModal" class="modal bluegrey grey-text">
	<div class="modal-content">
	  <h4 class="flow-text purple-text-logo">{{text.sendEverything}}</h4>
	  <p>{{text.sendEverythingDesc}} (<span id="mergeAccountLumens" class="white-text">0</span>) {{text.to}} <span id="mergeAccountDestination" style="word-wrap:break-word;" class="purple-text-logo"></span>?</p>
...
<div id="confirmSendModal" class="modal bluegrey grey-text">
	<div class="modal-content">
	  <h4 class="flow-text purple-text-logo">{{text.payment}}</h4>
	...
	<div class="modal-footer soft-bluegrey white-text">
	  <a class="modal-action modal-close waves-effect waves-green btn-flat white-text confirm">{{text.confirm}}</a>
...
<div id="languageModal" class="modal bluegrey grey-text">
	<div class="modal-content">
	  <h4 class="flow-text purple-text">{{text.language}}</h4>
	  <div class="row padding-UB-large">
		    <div class="input-field">
		    	  <i class="fa fa-flag center-align prefix"></i>
			    <select class="white-text" id="language">
	...
	<div class="modal-footer soft-bluegrey white-text">
	  <a class="modal-action modal-close waves-effect waves-green btn-flat purple-text setLanguage">{{text.set}}</a>
	  <a class="modal-action modal-close waves-effect waves-light btn-flat grey-text text-lighten-1">{{text.cancel}}</a>
	</div>
</div>

<div id="pinModal" class="modal purple-text-logo grey-text">
        <div class="modal-content">
                <h4 class="flow-text white-text">{{text.pin}}</h4>
                <div class="row padding-UB-large">
                        <div class="input-field"> 
...
<div id="securityModal" class="modal purple-text-logo grey-text">
        <div class="modal-content">
                <h4 class="flow-text white-text">{{text.securityConcerns}}</h4>
                <div class="row padding-UB-large">
