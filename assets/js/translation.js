/* This is the translation file for xlmwallet */
...
{	
	...
	$('body').html(replaced);
	 ...
	 $('#nav-mobile').prepend('<li> \
	 							<a class="changeLanguage white-text">  \
	 								<span><i class="fa fa-flag purple-text"></i> '+active_lang.toUpperCase()+'</span>  \
	 							</a>  \
	 						   </li>');

	 $('#walletnavmed, #walletnavsmall').prepend('<li> \
	 							<a class="changeLanguage white-text">  \
	 								<span><i class="fa fa-flag purple-text"></i> '+active_lang.substr(0,2).toUpperCase()+'</span>  \
	 							</a>  \
	 						   </li>');

	$('.changeLanguage').on('click', function() { $('#languageModal').modal('open'); });
	$('.setLanguage').on('click', setLanguage);
...
langs.english = {
	...
	"communityGetListed":"Want to be listed here? Please tell us on our <a href=\"https://galactictalk.org/d/1681-xlmwallet-convenient-account-viewer/\" target=\"_blank\">official thread</a> or through PM on GalacticTalk (@ultravision49).",
	"giveaway":"Lumens giveaway",
	"giveawayDesc":'We give lumens for reviews of wallet on forums.<br/> \
					You can learn everything about the giveway (how to join etc.) by clicking <a href="#" target="_blank">here</a>.',
	"getGiveawayCode":"GET MY XLMWALLET CODE",
	"settings":"Settings",
	...
	"english_s":"'s",
	"wallet":"wallet",
	"nonExistingAccountNotice":'This account doesn\'t exist on the network.<br/>To create this account, send it at least 1 Lumens (XLM) to fulfill the <a target="_blank" class="purple-text-logo text-darken-3" href="https://www.stellar.org/developers/learn/concepts/fees.html#minimum-balance"><u>minimum balance.</u></a>',
	"logout":"Logout",
	...
	"securityParagraph":"XLMwallet doesn't store your secret key on it's server.<br/> \
						If you use xlmwallet without enabling the mobile mode in the settings, then your secret key will be temporarily stored in a javascript variable, no risks.<br/> \
						...
						XLMwallet currently works on a PIN encryption system - as of now, the encryption system is weak and that's why we strongly recommend the mobile mode to only be enabled on mobile devices (preferably on iOS devices).<br/><br/> \
						Devs, xlmwallet is opensource! you can check and improve it: <a href=\"https://github.com/XlmWalletCo/xlmwallet\" target=\"_blank\">xlmwallet on github</a>",
...
langs.french = {
	...
	"communityGetListed":"Vous voulez apparaître ici? Demandez sur le <a href=\"https://galactictalk.org/d/1681-xlmwallet-convenient-account-viewer/\" target=\"_blank\">topic officiel</a> ou par MP sur GalacticTalk (@ultravision49).",
	"giveaway":"Distribution de Lumens",
	"giveawayDesc":'Nous donnons des lumens pour des critiques de portefeuille sur les forums.<br/> \
					Vous pouvez en apprendre plus en <a href="#" target="_blank">cliquant ici</a>.',
	"getGiveawayCode":"GENERER MON CODE XLMWALLET",
	"settings":"Réglages",
	...
	"english_s":"",
	"wallet":"",
	"nonExistingAccountNotice":'Ce compte n\'existe pas sur le réseau.<br/>Pour créer ce compte, envoyez au moins 1 Lumens (XLM) pour remplir le <a target="_blank" class="purple-text-logo text-darken-3" href="https://www.stellar.org/developers/learn/concepts/fees.html#minimum-balance"><u>solde minimum.</u></a>',
	"logout":"Déconnexion",
...
langs.italian = {
    ...
    "communityGetListed":"Vuoi essere elencato qui? Faccelo sapere sul nostro <a href=\"https://galactictalk.org/d/1681-xlmwallet-convenient-account-viewer/\" target=\"_blank\">thread ufficiale</a> o tramite PM su GalacticTalk (@ultravision49).",
    "giveaway":"Distribuzione Lumen",
    "giveawayDesc":'Diamo lumen per recensioni di portafoglio nei forum.<br/> \
                    Puoi saperne di più a riguardo (come partecipare etc.) cliccando <a href="#" target="_blank">qui</a>.',
    "getGiveawayCode":"DAMMI IL MIO CODICE XLMWALLET",
    ...
    "english_s":" ",
    "wallet":"wallet",
    "nonExistingAccountNotice":'Questo account non esiste ancora.<br/>Per crearlo inviagli almeno send 1 Lumen (XLM) per raggiungere il <a target="_blank" class="purple-text-logo text-darken-3" href="https://www.stellar.org/developers/learn/concepts/fees.html#minimum-balance"><u>deposito minimo.</u></a>',
    "logout":"Esci",
